...
export default function NavBar() {
  ...
  // Declare state to manage dialog open/close
  const [openReleaseDialog, setOpenReleaseDialog] = useState(false);

  // Function to handle opening of the release version dialog
  const handleOpenReleaseDialog = () => {
    setOpenReleaseDialog(true);
  };

  // Function to handle closing of the release version dialog
      ...
      <Toolbar>
        ...
        >
          ...
          <Dialog
            ...
            maxWidth="md"
          >
            <AppBar position="static" sx={{ bgcolor: "#E5D4ED" }}>
              <Toolbar>
                <Typography
                  variant="h6"
                  component="div"
